...
export const codexProviderPresets: CodexProviderPreset[] = (
  [
    ...
    },
    {
      name: "火山Agentplan",
      websiteUrl:
        "https://www.volcengine.com/activity/codingplan?ac=MMAP8JTTCAQ2&rc=6J6FV5N2&utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      apiKeyUrl:
        "https://www.volcengine.com/activity/codingplan?ac=MMAP8JTTCAQ2&rc=6J6FV5N2&utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
    ...
    },
    {
      name: "BytePlus",
      websiteUrl:
        "https://www.byteplus.com/en/product/modelark?utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      apiKeyUrl:
        "https://www.byteplus.com/en/product/modelark?utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
    ...
    },
    {
      name: "DouBaoSeed",
      websiteUrl:
        "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey?apikey=%7B%7D&utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      apiKeyUrl:
        "https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey?apikey=%7B%7D&utm_campaign=hw&utm_content=zxcode&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=zxcode",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
    ...
    },
    {
      ...
      apiKeyUrl:
        "https://teamorouter.com/?utm_source=zx_code&utm_medium=referral&utm_campaign=ai_directory",
      category: "aggregator",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "teamorouter",
...
requires_openai_auth = true`,
    ...
    },
    {
      name: "Kimi",
      primePartner: true,
      websiteUrl: "https://platform.kimi.com?aff=zx-code",
      apiKeyUrl: "https://platform.kimi.com/console/api-keys?aff=zx-code",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "kimi",
    ...
    },
    {
      ...
      primePartner: true,
      websiteUrl: "https://www.kimi.com/code/?aff=zx-code",
      apiKeyUrl: "https://www.kimi.com/code/?aff=zx-code",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "kimi_coding",
    ...
    },
    {
      ...
      apiKeyUrl: "https://www.packyapi.com/register?aff=zx-code",
      category: "third_party",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "packycode",
    ...
    },
    {
      ...
      apiKeyUrl: "https://apikey.fun/register?aff=ZXCode",
      category: "third_party",
      auth: generateThirdPartyAuth(""),
      config: `model_provider = "custom"
model = "gpt-5.5"
...
requires_openai_auth = true`,
    ...
    },
    {
      ...
      apiKeyUrl:
        "https://sudocode.chat/register?utm_source=zxcode&utm_medium=partner",
      category: "third_party",
      auth: generateThirdPartyAuth(""),
      config: `model_provider = "custom"
model = "gpt-5.6-sol"
...
requires_openai_auth = true`,
    ...
    },
    {
      ...
      apiKeyUrl: "https://claudecn.top/register?aff=zxcode",
      category: "third_party",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "claudecn",
    ...
    },
    {
      ...
      apiKeyUrl: "https://www.crazyrouter.com/register?aff=OZcm&ref=zx-code",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "crazyrouter",
    ...
    },
    {
      ...
      apiKeyUrl:
        "https://www.compshare.cn/coding-plan?ytag=GPU_YY_YX_git_zx-code",
      auth: generateThirdPartyAuth(""),
      config: generateThirdPartyConfig(
        "compshare",
...
base_url = "https://cc-api.pipellm.ai/v1"`,
  ...
  ] as CodexProviderPreset[]
).map((preset) => ({
  ...preset,
  isPartner: undefined,
  primePartner: undefined,
