...
ZX Code v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `ZX-Code-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `ZX-Code-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `ZX-Code-v3.8.0-Linux.AppImage` or `.deb`
...
[Use code "zx-code" for 10% off registration](https://www.packyapi.com/register?aff=zx-code)
...
- **Issue Reports**: [GitHub Issues](https://github.com/farion1231/zx-code/issues)
