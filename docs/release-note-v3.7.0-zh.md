...
ZX Code v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
访问 [Releases](https://github.com/farion1231/zx-code/releases/latest) 下载：

- **Windows**：`ZX-Code-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`ZX-Code-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`ZX-Code-v3.7.0-Linux.AppImage` 或 `.deb`
...
[使用 "zx-code" 代码注册可享受 10% 折扣](https://www.packyapi.com/register?aff=zx-code)

---

## 反馈与支持

- **问题反馈**：[GitHub Issues](https://github.com/farion1231/zx-code/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/zx-code/discussions)
