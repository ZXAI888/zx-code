...
| 文件 | 内容 |
|------|------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | ZX Code 存储、CLI 配置文件格式 |
...
- [GitHub Issues](https://github.com/farion1231/zx-code/issues)
- [GitHub Repository](https://github.com/farion1231/zx-code)
