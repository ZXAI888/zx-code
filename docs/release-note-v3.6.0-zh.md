...
- 从下方 [Assets](#assets) 下载 `ZX-Code-v3.6.0-macOS.zip`

> **注意**：由于作者没有苹果开发者账号，首次打开可能出现"未知开发者"警告。请前往"系统设置" → "隐私与安全性" → 点击"仍要打开"

### Windows

- **安装包**：`ZX-Code-v3.6.0-Windows.msi`
- **便携版**：`ZX-Code-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**：`ZX-Code-v3.6.0-Linux.AppImage`
- **Debian**：`ZX-Code-v3.6.0-Linux.deb`

---

## 文档

- [中文文档](https://github.com/farion1231/zx-code/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/zx-code/blob/main/README.md)
- [完整更新日志](https://github.com/farion1231/zx-code/blob/main/CHANGELOG.md)
...
**完整变更记录**: https://github.com/farion1231/zx-code/compare/v3.5.1...v3.6.0
