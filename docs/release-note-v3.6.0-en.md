...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/zx-code/blob/main/docs/release-note-v3.6.0-zh.md)**
...
- Download `ZX-Code-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `ZX-Code-v3.6.0-Windows.msi`
- **Portable**: `ZX-Code-v3.6.0-Windows-Portable.zip`
...
**Full Changelog**: https://github.com/farion1231/zx-code/compare/v3.5.1...v3.6.0
