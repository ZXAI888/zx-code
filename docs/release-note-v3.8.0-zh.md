...
ZX Code v3.8.0 是一次重大的架构升级版本，重构了数据持久化层和用户界面，为未来的云同步和本地代理功能奠定基础。
...
- **Windows**：`ZX-Code-v3.8.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`ZX-Code-v3.8.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`ZX-Code-v3.8.0-Linux.AppImage` 或 `.deb`
...
[使用 "zx-code" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=zx-code)
