...
//!
//! Parses zxcode:// URLs into DeepLinkImportRequest structures.
...
/// Parse a zxcode:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// zxcode://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "zxcode" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'zxcode', got '{scheme}'"
        )));
    }
